Public Class FrmModulo1

    'Llama al procedimiento que carga los nombres de los parametros de entrada y salida
    Private Sub FrmModulo1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        CargarM1() 'Llamado al procedimiento que carga los nombres de los parametros de entrada y salida
        btnResolver.Enabled = False
        btnGráfica.Visible = False
    End Sub

    'Llama al procedimiento que retorna a la pantalla de menu
    Private Sub FrmModulo1_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
        Salir()
    End Sub
    ...
    Private Sub BorrarTodoToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles BorrarTodoToolStripMenuItem.Click
        LimpiarM1() 'Llamado al procedimiento de limpieza
        btnResolver.Enabled = False
        btnGráfica.Visible = False
