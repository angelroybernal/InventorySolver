Module EOQ1Funciones
    Dim objeto As New FrmModulo1
    ...
    Public Sub calculoM1()
        Dim parametros(7) As Single
    ...
    Public Sub solucionM1()
        ...
        If Format(objeto.dgwEntrada.Item(1, 3).Value, Style:="") = "" Then
            objeto.dgwEntrada.Item(1, 3).Value = 0
        End If
        ...
        Else
            calculoM1() 'Llamado al procedimiento que calcula la respuesta
            objeto.GuardarToolStripMenuItem.Enabled = True
            objeto.btnGráfica.Visible = True
        End If
    End Sub

    'Crea la grafica para el modulo 1
    Public Sub GraficaM1()
        Dim Imax, Tc, tl, L As Single
